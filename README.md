...
Solutions for [Advent of Code 2016 (AOC)](https://adventofcode.com/) in [Rust](https://www.rust-lang.org/).
...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `1.9µs` | `22.0µs` |
| [Day 2](./src/bin/02.rs) | `30.3µs` | `36.2µs` |
| [Day 3](./src/bin/03.rs) | `71.4µs` | `72.1µs` |
| [Day 4](./src/bin/04.rs) | `353.9µs` | `98.4µs` |
| [Day 5](./src/bin/05.rs) | `1.3s` | `3.5s` |
| [Day 6](./src/bin/06.rs) | `29.8µs` | `34.8µs` |
| [Day 7](./src/bin/07.rs) | `484.5µs` | `675.3µs` |
| [Day 8](./src/bin/08.rs) | `8.1µs` | `6.8µs` |
| [Day 9](./src/bin/09.rs) | `1.2µs` | `47.8µs` |
| [Day 10](./src/bin/10.rs) | `270.1µs` | `265.2µs` |
| [Day 11](./src/bin/11.rs) | `3.9ms` | `18.2ms` |
| [Day 12](./src/bin/12.rs) | `1.5ms` | `39.2ms` |
| [Day 13](./src/bin/13.rs) | `11.4µs` | `7.0µs` |
| [Day 14](./src/bin/14.rs) | `6.8ms` | `6.6s` |
| [Day 15](./src/bin/15.rs) | `1.0µs` | `818.0ns` |
| [Day 16](./src/bin/16.rs) | `336.0ns` | `26.3ms` |
| [Day 17](./src/bin/17.rs) | `35.8µs` | `65.8ms` |
| [Day 18](./src/bin/18.rs) | `4.0µs` | `24.7ms` |
| [Day 19](./src/bin/19.rs) | `46.0ns` | `42.0ns` |
| [Day 20](./src/bin/20.rs) | `44.7µs` | `41.3µs` |
| [Day 21](./src/bin/21.rs) | `10.6µs` | `10.0µs` |
| [Day 22](./src/bin/22.rs) | `42.9ms` | `167.3µs` |
| [Day 23](./src/bin/23.rs) | `1.1µs` | `1.4µs` |
| [Day 24](./src/bin/24.rs) | `550.6µs` | `513.7µs` |
| [Day 25](./src/bin/25.rs) | `5.2ms` | `-` |
